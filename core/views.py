...
def portfolio(request):
    context = {
        'profile': {
            ...
            'bio': 'I am a fresher UI/UX Developer from Mumbai, Maharastra, focused on building clean, modern, and user-friendly digital experiences. I enjoy working on interface design, responsive layouts, wireframes, prototypes, and front-end screens that feel simple to use and visually polished. As a fresher, I am actively learning, improving my design thinking, and strengthening my technical skills every day.',
            'bio_paragraphs': [
                'I am a fresher UI/UX Developer from Mumbai, Maharastra, focused on building clean, modern, and user-friendly digital experiences. I enjoy working on interface design, responsive layouts, wireframes, prototypes, and front-end screens that feel simple to use and visually polished. As a fresher, I am actively learning, improving my design thinking, and strengthening my technical skills every day.',
                'My skills include HTML, CSS, JavaScript, responsive design, Figma, Photoshop, wireframing, prototyping, user research, design systems, GitHub, and clean visual presentation. I have hands-on experience through internships, technical support, data work, Flutter development, sales and marketing exposure, and real estate client handling, which helps me understand users, communication, problem solving, and real-world workflows. I am looking for opportunities where I can grow, contribute, learn from experienced teams, and create meaningful digital products.',
            ],
            'email': 'Rohanozaaa03@gmail.com',
            'phone': '+91 72087 90526',
